...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 19 MON | 9 MON | 19 MON | EIP-7702 delegated EOA | Real Monad Testnet authorization-list transaction | Sponsor | Sponsor | Yes | `false -> true -> false` | `findings.md` |
...
| 11 MON | 9 MON | 11 MON | Cheatcode-delegated EOA | Local Monad Foundry `vm.signAndAttachDelegation()` | Sponsor | Sponsor | Yes | `false -> false -> false` | `examples/reserve-probes/test/DelegatedDrain.t.sol` |
